...
@section('content')
<div class="container ps-4 d-flex flex-column ">
    <div class="page-header d-flex flex-column gap-3">
        <div class="navigation-prev d-flex flex-row align-items-center gap-2">
    ...
    <a href="{{ route('add-portfolio') }}"
        class="btn add-porto-btn yellow-gradient-btn position-fixed bottom-0 end-0 m-4 shadow">
