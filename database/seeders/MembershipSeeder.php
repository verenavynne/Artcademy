    ...
    public function run(): void
    {
        $memberships = [
            [
                ...
                'membershipBenefits' => ['Akses semua kursus Level Dasar', 'Sertifikat digital resmi Artcademy', 'Upload hingga 5 portofolio']
            ],
            ...
            [
                ...
                'membershipBenefits' => ['Akses kursus Level Dasar & Menengah', 'Sertifikasi digital resmi Artcademy','Upload hingga 10 portofolio']
            ],
            ...
            [
                ...
                'membershipBenefits' => ['Akses kursus Level Dasar, Menengah, Lanjutan', 'Sertifikasi digital resmi Artcademy', 'Upload portofolio tanpa batas']
            ],
        ];
